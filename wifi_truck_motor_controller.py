...
class WifiTruckMotorController(object):
    def __init__(self, addr=0x60, left_front_id=1, left_rear_id=2, right_front_id=3, right_rear_id=4, left_trim=0, right_trim=0,
                 stop_at_exit=True):
        """Create an instance of the truck controller.  Can specify the following optional
        parameters:
